function [state_out red_count_mix] = mix_columns (state_in, poly_mat)
...
for i_col_state = 1 : 4
    ...
    for i_row_state = 1 : 4
        ...
        for i_inner = 1 : 4
            ...
            [sub_red_count temp_prod] = poly_mult (...
            ...
            red_count_mix = red_count_mix + sub_red_count;
    ...
    %disp(['Mixcolumn: ', num2str(red_count)]);
