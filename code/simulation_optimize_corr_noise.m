%%%% This is the basic method of optimal linear transforms for simulated AES traces with
%%%% configurable band-limited noise power (pow_band_noise) and randomization (rand_cycle_count)
close all;
clear all;
